...
**Постановка задачи:**  
Использовать битовые поля для компактного хранения даты.
...
**Постановка задачи:**  
Реализовать двунаправленный связный список с обходом в прямом и обратном направлениях.
...
**Постановка задачи:**  
Использовать указатель на объединение для работы с разными типами данных.
...
**Постановка задачи:**  
Использовать объединение для побайтовой распечатки числа типа `unsigned long`.
...
**Постановка задачи:**  
Создать перечисление для дней недели и вывести их значения как целые числа.
...
**Постановка задачи:**  
Создать размеченное объединение в структуре с полем-перечислением для хранения информации о типе данных.
